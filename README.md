...
* `--encrypt` - шифрование файла при помощи `--encrypt-cmd` перед операцией загрузки в хранилище;
...
* `--decrypt` - расшифровка файла при помощи `--decrypt-cmd` после операции получения из хранилища;
